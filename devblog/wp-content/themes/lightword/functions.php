...
$options = array (
    ...
    array(  "name" => __('Custom image header','lightword'),
			"desc" => __('Check this box if you would like to SHOW IMAGE instead of Cuf&oacute;n text on header.<br/>Image location: <code>lightword/images/header-image.png</code> / Max width: <code>796px</code>','lightword'),
...
<div class="stuffbox">
<h3><label for="link_url"><?php _e('Search for help','lightword'); ?> (<a href="http://www.lightwordtheme.org/">blog</a> <?php _e('or','lightword'); ?> <a href="http://twitter.com/andreiluca">twitter</a>)</label></h3>
<div class="inside">
<?php
...
/** Added by Steven L of ISomehowHate.com and modifieed by Andrei on 07.4
