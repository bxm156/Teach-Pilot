...
/// Start main column
	...
	//Begin Editing from main template
    //print_heading_block(get_string('weeklyoutline'), 'outline');
	echo <<<EOF
	<div class="itacContainer">
	<img src="format/itac/images/case.gif">
		<div class="itacLeftColumn">
EOF;
	
		if(array_key_exists('casecourseware',$modnamesused)) {
			echo <<< EOF
			<div class="itacButton">
				<a href="http://teach.case.edu/moodle/mod/casecourseware/index.php?id={$course->id}"><img src="format/itac/images/videos.gif" border="0"></a>
			</div>
EOF;
		 }
		 if(array_key_exists('vimoodle',$modnamesused)) {
		 	echo <<< EOF
 			<div class="itacButton">
				<a href="http://teach.case.edu/moodle/mod/vimoodle/index.php?id={$course->id}"><img src="format/itac/images/vimeo.gif" border="0"></a>
			</div>
EOF;
		 }
		if(array_key_exists('bigbluebutton',$modnamesused)) {
			echo <<< EOF
			<div class="itacButton">
				<a href="http://teach.case.edu/moodle/mod/bigbluebutton/index.php?id={$course->id}"><img src="format/itac/images/bbb.gif" border="0"></a>
			</div>
EOF;
		}
		echo <<< EOF
		</div>
		<div class="itacRightColumn">
EOF;
		if(array_key_exists('resource',$modnamesused)) {
			echo <<< EOF
			<div class="itacButton">
				<a href="http://teach.case.edu/moodle/mod/resource/index.php?id={$course->id}"><img src="format/itac/images/resources.gif" border="0"></a>
			</div>
EOF;
		}
		if(array_key_exists('quiz',$modnamesused)) {
			echo <<< EOF
			<div class="itacButton">
				<a href="http://teach.case.edu/moodle/mod/quiz/index.php?id={$course->id}"><img src="format/itac/images/quizes.gif" border="0"></a>
			</div>
EOF;
		}
		echo <<< EOF
			<div class="itacButton">
				<a href="http://teach.case.edu/moodle/grade/report/index.php?id={$course->id}"><img src="format/itac/images/grades.gif" border="0"></a>
			</div>
		</div>
		<div class="itacClear"></div>
	</div>
