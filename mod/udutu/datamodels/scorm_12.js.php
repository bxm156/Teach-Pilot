            ...
            if (!Initialized) {
                <?php 
                    if (debugging('',DEBUG_DEVELOPER)) {
                        echo 'alert("Initialized udutu 1.2");';
                    }
                ?>
                Initialized = true;
                errorCode = "0";
