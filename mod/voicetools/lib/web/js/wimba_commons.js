...
function hideArchive(element) {
    ...
    {           
        ...
        {
            if(  allElements[i].hasClassName('hideElement') && ($("view") == null || $("view").value == "normal") || $("view").value == "student" && allElements[i].hasClassName('element.available') && allElements[i].hasClassName('hideElement'))
            {
                allElements[i].removeClassName('hideElement');
