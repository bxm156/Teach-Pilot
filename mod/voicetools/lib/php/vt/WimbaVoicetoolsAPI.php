...
function voicetools_api_create_resource ($resource_data)
{
    ...
    if ($err) 
    {
        wimba_add_log (WIMBA_ERROR, voicetools_LOGS, __FUNCTION__ . ' : Error to create the soap element : ' . $err);
        return false;
    } 
    ...
    if ($soapclient->fault) 
    {
        wimba_add_log (WIMBA_ERROR, voicetools_LOGS, __FUNCTION__ . ' : Fault with the web service : ' . $soapclient->fault);
        return false;
    } 
    else 
    {
        ...
        if ($err) 
        {
            wimba_add_log (WIMBA_ERROR, voicetools_LOGS, __FUNCTION__ . ' : error with the web service : ' . $err);
            return false;
        } 
    } 
