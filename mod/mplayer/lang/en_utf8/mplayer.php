...
$string['embederror1'] = '<h2>Oops! There\'s a problem.</h2>
<p><strong>This module requires Flash Player ';
$string['embederror2'] = ' or later to be installed on this computer.</strong></p>
<p><strong>Click on the Adobe link below to install or upgrade to the latest version.</strong></p>
<p><strong>Administration priviledges on your computer\'s operating system are required to complete a Flash Player installation or upgrade.</strong></p>';
//---------------------------------------------------------------------------------------------
