...
//// --------------------------------------------------------- appearance ---------------------------------------------------------
	...
	if($mplayer->image != '')
	{
		$mplayer->image = '&image='.$mplayer->moodledata.$mplayer->image;
	}
...
function mplayer_print_body_flashvars($mplayer)
{
	...
	$mplayer_flashvars = '<param name="flashvars" value="'.
				...
				$mplayer->author.
				$mplayer->backcolor.
				'&bufferlength='.$mplayer->bufferlength.
				$mplayer->captionsback.
				$mplayer->captionsfile.
				$mplayer->captionsfontsize.
				$mplayer->captionsstate.
				$mplayer->configxml.
				'&controlbar='.$mplayer->controlbar.
				$mplayer->mplayerdate.
				$mplayer->description.
