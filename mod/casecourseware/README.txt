...
Rename the casecourseware folder into a lower case name of your module. Make sure
...
instances of string "casecourseware" to your new module name (eg "widget").
   
Rename the file lang/en_utf8/casecourseware.php to widget.php or whatever your
module name is.
...
should find that this casecourseware has been added to the list of recognized
modules.  
...
Credits for work on this casecourseware template
-------------------------------------------
