...
$activities = count_records("voiceauthoring", "course", $course_id);
$bvoiceauthoring = get_record("block", "name","bvoicerecorder");       
$blocks = count_records("block_instance", "pageid", $course_id,"blockid",$bvoiceauthoring->id);                 
