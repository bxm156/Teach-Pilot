...
function wrsqz_print_db_message($allwell){
	...
	if($allwell){
		...
		echo '<div align="left">';
		echo utf8_htmlentities(translate('An error occurred while modifying the database. Please see the')),'<a href="http://www.wiris.com/documents/quizzes-install.html">',utf8_htmlentities(translate('manual install documentation')),'</a> in order to modify manually the database.<br /><br />';
		echo '</div>';
