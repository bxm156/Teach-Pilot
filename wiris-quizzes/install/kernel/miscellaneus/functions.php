...
function errorMessage($tag = '') {
	$toReturn = translate('If you want to install WIRIS Quizzes manually, see') . ' <a href="http://www.wiris.com/download/moodle/install.html#' . $tag . '">' . translate('our manual') . '</a>.<br /><br />';
