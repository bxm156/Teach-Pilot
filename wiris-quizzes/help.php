<?php
/*
 * This file replaces the moodle/htlp.php for wiris quizzes help pages. This is
 ...
 */
    ...
    if (file_exists($CFG->dirroot . '/wiris-quizzes/lang/' . $lang . '/help/'. $file)){
        ...
        echo 'This is a WIRIS quizzes feature. Please go to <a href="http://www'.
        '.wiris.com/documents/quizzes-user-manual.html"> WIRIS quizzes user man'.
        'ual</a> for more information.';
    }
