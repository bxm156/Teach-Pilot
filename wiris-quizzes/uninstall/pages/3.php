...
if (!$ok){
	echo '<b>'.utf8_htmlentities(translate('There were problems during the uninstall process. Please uninstall WIRIS Quizzes manually. See the ')).'<a href="http://www.wiris.com/documents/quizzes-uninstall.html">'.utf8_htmlentities(translate('uninstall documentation')).'</a>.</b>';
}else{
